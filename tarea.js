...
function tienenMismaLongitud(str1, str2) {
  ...
  let array = ["bmw","mercedes","ducati","spark"];
  ...
  const usuarios = {
    usuariopremium:[{esPremium: true,},{esPremium: true,},{esPremium: true,},{esPremium: true,},{esPremium: true,},]
  }

  const premium = usuarios.usuariopremium
